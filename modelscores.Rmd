...
smear <- read.csv(file = '/home/laatopi/Documents/SmearTest/smear2008-11.csv')

names(smear)[names(smear) == 'HYY_EDDY233.u_star'] <- 'FricVel'
names(smear)[names(smear) == 'HYY_META.T336'] <- 'AirTemp'
names(smear)[names(smear) == 'HYY_META.tsoil_B2'] <- 'SoilTempB'
names(smear)[names(smear) == 'HYY_META.tsoil_A'] <- 'SoilTempA'
names(smear)[names(smear) == 'HYY_META.RHTd'] <- 'RelHum'
names(smear)[names(smear) == 'HYY_META.PAR2'] <- 'PPFD'
names(smear)[names(smear) == 'HYY_META.wsoil_B2'] <- 'SoilWatCont'
names(smear)[names(smear) == 'HYY_META.diffPAR'] <- 'PPFDdiff'
names(smear)[names(smear) == 'HYY_EDDY233.NEE'] <- 'NEP'
